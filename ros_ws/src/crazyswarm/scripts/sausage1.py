...
class OpenBlimp:
        ...
        try:
            ...
            while not self.timeHelper.isShutdown():
                ...
                if b_state:
                    ...
                    tauz = 0
                    taux = 0
                    self._cf1.cmdPosition([fx, fz, tauz], taux)
                    self._cf2.cmdPosition([fx, fz, tauz], taux)
                else:
                    ...
                    identity = 1
                    self._cf1.cmdFullState([fx, fz, tx], [ty, tz, 1],[0, 0, 0], 0, [0, 0, 0])
                    self._cf2.cmdFullState([fx, fz, tx], [ty, tz, 2],[0, 0, 0], 0, [0, 0, 0])
    ...
    def update_joydata(self):
        if lastData != None:
            ...
            self.joy_tauz = lastData.axes[3] #tauz
